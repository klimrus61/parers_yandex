...
class TrackingFluctuations():
    ...
    def _get_average_sum(self, tracked_cell, user_name, app_name) -> int:
        ...
        last_seven_days_sum = 0
        count_days_of_week_with_values = 0
        count_days = 0
        ...
        while previous_worksheet_index >= 0 and count_days < 7:
        ...
        if count_days_of_week_with_values > 0:
            average_previous_seven_days_sum = last_seven_days_sum / count_days_of_week_with_values
